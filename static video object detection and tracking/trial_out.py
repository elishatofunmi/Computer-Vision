...
while(True):
    ...
    if ret == True:
      ...
      sequence_frame.append(image_np_with_detections)
...
video = ImageSequenceClip(sequence_frame, fps=40)
video.write_videofile('test_us.mp4', fps=40)
cap.release()
